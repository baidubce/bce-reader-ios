Pod::Spec.new do |s|
  ...
  s.source   =   { :http => 'http://sdk.bce.baidu.com/media-sdk/Baidu-DocReader-SDK-iOS-2.2.1.zip?responseContentDisposition=attachment',:sha1 => "ec99c497bddeaa4bf3625900589ca1f61392e3db"}
