Pod::Spec.new do |s|
  ...
  s.source   =   { :http => 'http://sdk.bce.baidu.com/media-sdk/Baidu-DocReader-SDK-iOS-2.3.0.zip?responseContentDisposition=attachment',:sha1 => "2b9ea5014b3b32c46c676d6958e671699d45332d"}
